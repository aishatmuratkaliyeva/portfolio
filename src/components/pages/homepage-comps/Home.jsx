      ...
      <section name="Home" className='relative w-full md:h-screen h-unset'>
        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 py-16 md:py-0 md:flex-row md:gap-8'>
          ...
          <div className='flex flex-col justify-center items-center h-[85%] md:h-full order-2 md:order-1 md:items-start'>
            ...
            <h1 className='text-4xl md:text-6xl font-bold text-white mb-2 mt-3 md:mt-0 md:mb-4'>Меня зовут Мураткалиева Айшат</h1>
            <h2 className='rounded-md bg-primary-color/20 max-w-max px-6 inline text-xl md:text-3xl lg:text-4xl font-semibold text-white'>Я студент</h2>
            <p className='text-gray-300 py-4 max-x-md text-justify'>Добро пожаловать в моё портфолио! Здесь вы можете узнать обо мне чуть больше через мои работы. 
            Я стремлюсь к тому, чтобы каждый проект был не просто отражением моих навыков, но и моего стиля и взглядов на мир.</p>
...
/>
              ...
              {/* <img src="https://imgur.com/a/2Droezi.png" className='rounded-1xl mx-auto w-2/3 max-w-lg md:max-w-sm object-cover md:w-[60rem] shadow-1xl shadow-primary-color/10' style={{ filter: 'drop-shadow(0px -2px 2px rgba(0, 250, 0, 0))' }} /> */}
            </div>
        </div>
      </section>
    );
